	...
	<div class="xbox" style="margin:0;">
		<table class="ttable">
			<tr>
				...
				<th style="text-align:center;" title="ADC">ADC</th>
				...
				<th style="text-align:center;" title="GPIO0">10</th>
				<th style="text-align:center;" title="GPIO1">12</th>
				<th style="text-align:center;" title="GPIO2">13</th>
				<th style="text-align:center;" title="GPIO4">14</th>
...
?>
				...
				<td style="text-align:center;"><?php echo $json_array['adc']; ?></td>
				<td style="text-align:right;"><?php echo $json_array['adc_reading']; ?></td>
				<td style="text-align:right;"><?php echo $json_array['adc_trigger']; ?></td>
